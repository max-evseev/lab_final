...
import {name_validity, email_validity, phone_validity} from '../services/booking_service.js'
import {useState} from 'react'
    ...
    const [phone, set_phone] = useState('');
        ...
        <div className="booking_form">
            ...
            <button className={"form_button" + button_lock()} disabled={button_lock() === ' locked'}>Забронювати</button>
        </div>
        );
    }